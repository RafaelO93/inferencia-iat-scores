...
iat %>% 
    group_by(sex) %>% 
    summarise(media = mean(d_art), n=n(), std = sd(d_art)
              )
```
...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemárica **negativa** e **média** (média XXX, desv. padrão YYY, N = ZZZ). Homens tiveram uma associação **positiva** com a matemática, portanto **maior** que a das mulheres (média , desv. padrão, N = ). Houve portanto uma **grande/considerável/pequena** diferença entre homens e mulheres (diferença das médias XXXX, 95% CI [CCC, DDD]). A partir desta amostra, estimamos que...
